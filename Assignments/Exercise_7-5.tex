...
\begin{question}{\thequestion}{2}
    ...
    Write a path, starting at $(WCTG, \emptyset)$ and ending at $(\emptyset, WGTC)$,
    ...
    \begin{center}
        \begin{tikzpicture}[arrow/.style = {thick,-stealth}]
            ...
            \draw[arrow] (2,1.7) -- (3.5,1.7);
                ...
                \node at        (4.2,   2.3) {O};
                \node at        (5.3,   2.3) {X};
                \node[blue] at  (4.7,   1.7) {X};
                \node at        (4.2,   1.7) {X};
                \node at        (4.2,   1.2) {X};
                \node at        (4.7,   1.2) {O};
                \node at        (5.3,   1.2) {O};

                \draw (4.2, 1.2) -- (5.3, 2.3);

            \draw[arrow] (3,1.7) -- (3,0) -- (3.5,0);
                \draw           (4.5,   0.5)    -- (4.5,    -1);
                \draw           (5,     0.5)    -- (5.0,    -1);
                \draw           (4,     -0.5)   -- (5.5,   -0.5);
                \draw           (4,     0)      -- (5.5,    0);
            ...
            \node at        (12.2,   1.3) {O};
            \node at        (12.8,   1.8) {O};
            \node[blue] at  (12.2,   1.8) {O};

            \draw (11.7, 2.3) -- (12.8, 1.3);
