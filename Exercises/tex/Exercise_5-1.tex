    ...
    \begin{questionNOGRADE}{\thequestion}
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \filldraw[red,fill=white] (-4,3) circle (10pt) node{T};
                \filldraw[red,fill=white] (4,3) circle (10pt) node{H};
                
                \filldraw[blue,fill=white] (-6,2) circle (10pt) node{T};
                \filldraw[blue,fill=white] (-2,2) circle (10pt) node{H};
                
                \filldraw[blue,fill=white] (6,2) circle (10pt) node{H};
                \filldraw[blue,fill=white] (2,2) circle (10pt) node{T};
                
                \filldraw[purple,fill=white] (-7,1) circle (10pt) node{T};
                \filldraw[purple,fill=white] (-5,1) circle (10pt) node{H};
                
                \filldraw[purple,fill=white] (-3,1) circle (10pt) node{T};
                \filldraw[purple,fill=white] (-1,1) circle (10pt) node{H};
                
                \filldraw[purple,fill=white] (7,1) circle (10pt) node{H};
                \filldraw[purple,fill=white] (5,1) circle (10pt) node{T};
                
                \filldraw[purple,fill=white] (3,1) circle (10pt) node{H};
                \filldraw[purple,fill=white] (1,1) circle (10pt) node{T};
            \end{tikzpicture}
        \end{center}
