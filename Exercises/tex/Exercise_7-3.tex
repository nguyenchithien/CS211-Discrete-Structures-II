...
\input{INSTRUCTIONS-EXERCISE}
    ...
    \stepcounter{question}
    \begin{questionNOGRADE}{\thequestion}
        For the two graphs given, fill out a table of vertex mappings,
        and of edge mappings. ~\\
        ...
        \begin{tikzpicture}
            ...
            \draw[blue]     (10,2) -- (10,0);
            \draw[orange]   (10,0) -- (8,0);
            \draw[red]      (8,0) -- (8,2);
        
            \filldraw   (10,2) circle (2pt) node[right] {3};
            \filldraw   (8,2) circle (2pt) node[left]   {4};
            \filldraw   (10,0) circle (2pt) node[right] {2};
            \filldraw   (8,0) circle (2pt) node[left]   {1};
        ...
        \begin{center}
            \begin{tabular}{c p{3cm} c}
                ...
                \begin{tikzpicture}
                    ...
                    \filldraw (3,0)     circle (1pt) node[right] {e};
