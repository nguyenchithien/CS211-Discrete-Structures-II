...
\input{INSTRUCTIONS-EXERCISE}
    ...
    \begin{intro}{Properties of Functions}
    ...
    \begin{questionNOGRADE}{\thequestion}
        ...
        \begin{itemize}
            \item[a.]
                ...
                Is it Onto? \solution{ yes, every domain element has an input }{} \\
                Is it One-to-one? \solution{ yes, every domain element has max 1 input }{}
            ...
            \item[c.]
                ...
                Is it Onto? \solution{ no, the bottom domain element doesn't have an input }{} \\
                Is it One-to-one? \solution{ no, one element has 2 inputs }{}
